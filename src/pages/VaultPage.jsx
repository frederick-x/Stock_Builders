    ...
    <div className="vault-page-container">
      ...
      <div className="vault-disclaimer-banner">
        ...
        <div className="disclaimer-text">
          <strong>VIRTUAL IN-GAME TOKENS ONLY</strong> &bull; STOCKBUILDERS is a risk-free strategy simulation. No cryptocurrency, blockchain, wallets, or real-money transactions exist in this ecosystem.
        </div>
      </div>
